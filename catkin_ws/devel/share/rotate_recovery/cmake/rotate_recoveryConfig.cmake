...
if(NOT "/home/ubuntu/catkin_ws/src/navigation/rotate_recovery/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rotate_recovery' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws/src/navigation/rotate_recovery/${idir}'.  ${_report}")
    endif()

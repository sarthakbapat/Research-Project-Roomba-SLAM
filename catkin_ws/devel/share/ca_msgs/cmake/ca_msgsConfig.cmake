...
if("TRUE" STREQUAL "TRUE")
  set(ca_msgs_SOURCE_PREFIX /home/ubuntu/catkin_ws/src/create_autonomy/ca_msgs)
  set(ca_msgs_DEVEL_PREFIX /home/ubuntu/catkin_ws/devel)
  set(ca_msgs_INSTALL_PREFIX "")
  set(ca_msgs_PREFIX ${ca_msgs_DEVEL_PREFIX})
else()
  set(ca_msgs_SOURCE_PREFIX "")
  set(ca_msgs_DEVEL_PREFIX "")
  set(ca_msgs_INSTALL_PREFIX /home/ubuntu/catkin_ws/install)
...
if(NOT "/home/ubuntu/catkin_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ca_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws/src/create_autonomy/ca_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT ca_msgs_NUM_DUMMY_TARGETS)
      set(ca_msgs_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::ca_msgs::wrapped-linker-option${ca_msgs_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR ca_msgs_NUM_DUMMY_TARGETS "${ca_msgs_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::ca_msgs::wrapped-linker-option${ca_msgs_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND ca_msgs_LIBRARIES "${interface_target_name}")

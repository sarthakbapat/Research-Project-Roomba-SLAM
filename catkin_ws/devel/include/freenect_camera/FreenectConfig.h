...
//#line 290 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(FreenectConfig::AbstractParamDescriptionConstPtr(new FreenectConfig::ParamDescription<int>("image_mode", "int", 0, "Image output mode", "{'enum_description': 'output mode', 'enum': [{'srcline': 8, 'description': '1280x1024', 'srcfile': '/home/ubuntu/catkin_ws/src/freenect_stack/freenect_camera/cfg/Freenect.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'SXGA'}, {'srcline': 9, 'description': '640x480', 'srcfile': '/home/ubuntu/catkin_ws/src/freenect_stack/freenect_camera/cfg/Freenect.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'VGA'}]}", &FreenectConfig::image_mode)));
//#line 290 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 290 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(FreenectConfig::AbstractParamDescriptionConstPtr(new FreenectConfig::ParamDescription<int>("depth_mode", "int", 0, "Depth output mode", "{'enum_description': 'output mode', 'enum': [{'srcline': 8, 'description': '1280x1024', 'srcfile': '/home/ubuntu/catkin_ws/src/freenect_stack/freenect_camera/cfg/Freenect.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'SXGA'}, {'srcline': 9, 'description': '640x480', 'srcfile': '/home/ubuntu/catkin_ws/src/freenect_stack/freenect_camera/cfg/Freenect.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'VGA'}]}", &FreenectConfig::depth_mode)));
//#line 290 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(FreenectConfig::AbstractParamDescriptionConstPtr(new FreenectConfig::ParamDescription<int>("depth_mode", "int", 0, "Depth output mode", "{'enum_description': 'output mode', 'enum': [{'srcline': 8, 'description': '1280x1024', 'srcfile': '/home/ubuntu/catkin_ws/src/freenect_stack/freenect_camera/cfg/Freenect.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'SXGA'}, {'srcline': 9, 'description': '640x480', 'srcfile': '/home/ubuntu/catkin_ws/src/freenect_stack/freenect_camera/cfg/Freenect.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'VGA'}]}", &FreenectConfig::depth_mode)));
//#line 290 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 8 "/home/ubuntu/catkin_ws/src/freenect_stack/freenect_camera/cfg/Freenect.cfg"
      const int Freenect_SXGA = 1;
//#line 9 "/home/ubuntu/catkin_ws/src/freenect_stack/freenect_camera/cfg/Freenect.cfg"
